...
const authUser = (name, filename = '') => {
    let data = loadJSON(filename)
    let userExists = checkUser(name, data)
    return userExists
}

const loggedOn = (name, filename = '') => {
    let data = loadJSON(filename)
...
const addLine = (chatline, filename = '') => { 
